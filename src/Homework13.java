        ...
        for (String city : citiesArray) {
            if (city.toLowerCase().matches("^" + userInputFirst.toLowerCase() + ".*")) {
                ...
                counterFirst++;
                    ...
                    System.out.println("No city name starts with this letter!");
                    break;
                }
            }
...
//        }
        ...
        for (String city : citiesArray) {
            if (city.toLowerCase().matches(".*" + userInputLast.toLowerCase() + "")) {
                ...
                counterLast++;
            } else if (counterLast == 0) {
                System.out.println("No city name ends with this letter!");
                break;
            }
        }
        ...
        for (int i = 0; i < citiesArray.length; i++) {
            if (citiesArray[i].length() == userInputLength) {
                ...
                System.out.println("There is no city name with such length!");
                break;
            }
        ...
        for (String city : citiesArray) {
            if (city.matches(".*" + userInput + ".*")) {
                ...
                System.out.println("There is no city name that consists of your input!");
                break;
            }
        }
